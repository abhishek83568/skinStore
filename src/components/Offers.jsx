...
const Offers = () => {
    ...
    const fetchProducts = async (discount) => {
        const url = discount === '15%' ? 'http://localhost:8080/Offers15' : 'http://localhost:8080/Offers50';
    ...
    return (
        <div className="offers-container">
            <div style={{ display: "flex", justifyContent: "center" }}>
                <button onClick={handle15Discount} className='firstDiscount'>15% off The Ordinary</button>
                <button onClick={handle50Discount} className='SecondDiscount'>Up to 50% off</button>
            </div>
